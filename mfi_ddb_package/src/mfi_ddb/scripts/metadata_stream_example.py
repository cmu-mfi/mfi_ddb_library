...
class MetadataAdapter(mfi_ddb.BaseDataAdapter):
    ...
    def __init__(self, metadata_type: str) -> None:
        ...
        self.attributes["metadata"] = {"type": "metadata_type"}
...
if __name__ == "__main__":
    ...
    $ python -m mfi_ddb.scripts.metadata_stream_example --streamer_cfg ./configs/streamer.yaml
    ...
    try:
        ...
        exception_msg = (
            "STREAMER CONFIG NOT FOUND. ENSURE THE FILE EXISTS:"
            f"{os.path.abspath(streamer_config_file)}"
        )
