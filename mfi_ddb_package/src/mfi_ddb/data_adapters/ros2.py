...
class Ros2DataAdapter(BaseDataAdapter):
    ...
    CONFIG_HELP = {
        ...
        "Each device should have a 'namespace' and a list of 'rostopics' to subscribe to."
        "'attributes' are optional and can be used to set the attributes of the device.",
    }
    CONFIG_EXAMPLE = {
    ...
    def __init__(self, config: dict) -> None:
        ...
        try:
            ...
            raise Exception(f"Failed to initialize ROS2 node: {e}") from None
        ...
        for device_name in self.cfg["devices"]:
            ...
            if "trial_id" in self.cfg:
                self.attributes[device_name].setdefault("trial_id", self.cfg["trial_id"])
