import copy
import logging
import time  # Added for latency measurements
...
class __DwsAgent:
    ...
    def get_data(self, topics: Union[str, List[str]], time_start: str, time_end: str) -> Dict:
        ...
        # Format representative label for telemetry categorization
...
# Explicitly instantiate and expose as expected by other app services
DwsAgent = __DwsAgent()